...
Route::get('/contact-us', [\App\Http\Controllers\LandingController::class, 'contactUs'])->name('landing.contact');

Route::get('/blog', [\App\Http\Controllers\BlogController::class, 'home'])->name('blog.home');
